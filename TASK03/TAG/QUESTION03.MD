...
Goldie apresentou a meta do próximo trimestre à diretoria: 15% de redução no custo cloud até o fim do período, sem degradar SLA.

Doc Brown pegou o breakdown de custos AWS do último mês e repassou a análise inicial para o time. O CSV está abaixo.
...
Prompt, modelo, output e justificativa mostrando como Task, Action e Goal aparecem no prompt.
